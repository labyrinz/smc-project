  ...
  .controller('MainCtrl', function ($scope) {
      ...
      //-----TIMELINE ---------
        ...
        tl
          ...
          .to(".ny4", 0.3, {transform: 'rotateY(150deg)', ease: Power2.easeIn})
          .to(".ny3", 0.3, {transform: 'rotateY(150deg)', ease: Power2.easeIn})
          .to(".ny1", 0.3, {transform: 'rotateY(150deg)', ease: Power2.easeIn})
          .to(".ny2", 0.3, {transform: 'rotateY(150deg)', ease: Power2.easeIn})
          ...
          .to(".ber1", 0.3, {transform: 'rotateY(150deg)', ease: Back.easeOut.config(1)})
