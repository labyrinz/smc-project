  ...
  .controller('MainCtrl', function ($scope) {
      ...
      //-----TIMELINE ---------
        ...
        tl
          ...
          .to("#page16",0.4,{ right: '100%', ease: Power0.easeNone},"lasVegas")
          .to("#page17",0.4,{ right: '0%', ease: Power0.easeNone})
          .call(updateTitle,[16])
          .staggerFrom($("#page17").children(),0.6, animationFromPattern, staggerFromVelocity,"charoBaeza")
          .addPause()
          //EPISODE 19
