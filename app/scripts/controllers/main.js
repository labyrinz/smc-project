  ...
  .controller('MainCtrl', function ($scope,deviceDetector) {
    ...
    //if( !isMobile ) {
      tl
        ...
        .to("", 0.1, { onStart: stopVideo })
        .to("", 2, { onComplete: playNarracion, onCompleteParams: ['04-narracion-rm1', false] })
        ...
        .to("", 0.1, { onStart: stopVideo })
        .to("", 2, { onComplete: playNarracion, onCompleteParams: ['06-narracion-cc3', false] },'+=1')
        ...
        .to("", 2, { onComplete: playNarracion, onCompleteParams: ['07-narracion-la2', false] })
        ...
        .to("", 0.1, { onStart: stopVideo })
        .to("", 2, { onComplete: playNarracion, onCompleteParams: ['08-narracion-al1', false] })
        ...
        .to("", 2, { onComplete: playNarracion, onCompleteParams: ['09-narracion-al3', false] })
