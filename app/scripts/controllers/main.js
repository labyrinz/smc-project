  ...
  .controller('MainCtrl', function ($scope) {
      ...
      //-----TIMELINE ---------
        ...
        tl
          ...
          .addPause()
          //EPISODE 3
          .to(".texto11", 0.5, {scale: '0', ease: Back.easeOut.config(0.7)})
          .to(".texto12", 0.5, {scale: '0', ease: Back.easeOut.config(0.7)},"-=0.3")
          .to(".texto13", 0.5, {scale: '0', ease: Back.easeOut.config(0.7)},"-=0.3")
          .to(".cita11", 0.5, {scale: '0', ease: Back.easeOut.config(0.7)},"-=0.3")
          .to(".prelGroup", 0.5, {scale: '0', ease: Back.easeOut.config(0.7)},"-=0.3")
          ...
          .to(".prel06",0.4,{ top: '10%',scale: '1', ease: Back.easeOut.config(1)},"-=0.2")
          .to(".texto14",0.4,{ top: '48%',scale: '1', ease: Back.easeOut.config(1)},"-=0.2")
          .to(".texto15",0.4,{ top: '65%',scale: '1', ease: Back.easeOut.config(1)},"-=0.2")
          .to(".texto16",0.4,{ top: '78%',scale: '1', ease: Back.easeOut.config(1)},"-=0.2")
          .addPause()
          //EPISODE 5
          .to(".prel05",0.4,{ scale: '0', ease: Back.easeOut.config(1)})
          .to(".prelpant1",0.4,{ scale: '0', ease: Back.easeOut.config(1)},"-=0.2")
          .to(".prel06",0.4,{ scale: '0', ease: Back.easeOut.config(1)},"-=0.2")
          .to(".texto14",0.4,{ scale: '0', ease: Back.easeOut.config(1)},"-=0.2")
          .to(".texto15",0.4,{ scale: '0', ease: Back.easeOut.config(1)},"-=0.2")
          .to(".texto16",0.4,{ scale: '0', ease: Back.easeOut.config(1)},"-=0.2")
          .to(".cub1", 0.5, {transform: 'rotateY(165deg)', ease: Power2.easeIn})
          .to("#page3",0.4,{ right: '100%', ease: Back.easeInOut.config(1)},"-=0.4")
          .to("#page4",0.4,{ right: '0%', ease: Back.easeInOut.config(1)},"-=0.4")
          ...
          .to(".p31Video",0.4,{ right: '10%', ease: Back.easeOut.config(1)},"-=0.2")
          .addPause()
          //EPISODE 6
          //.to(".texto17",0.4,{ right: '150%', ease: Back.easeOut.config(1)})
          //.to(".texto18",0.4,{ right: '150%', ease: Back.easeOut.config(1)},"-=0.2")
          //.to(".cita12",0.4,{ right: '150%', ease: Back.easeOut.config(1)},"-=0.2")
          //.to(".p31Video",0.4,{ right: '150%', ease: Back.easeOut.config(1)},"-=0.2")
          ...
          .addPause()
          //EPISODE 7
          //.to(".rm12",0.4,{ right: '150%', ease: Back.easeOut.config(1)})
          //.to(".texto21",0.4,{ right: '150%', ease: Back.easeOut.config(1)},"-=0.2")
          //.to(".cita13",0.4,{ right: '150%', ease: Back.easeOut.config(1)},"-=0.2")
          //.to(".rm11",0.4,{ right: '150%', ease: Back.easeOut.config(1)},"-=0.2")
          //.to(".rm13",0.4,{ right: '150%', ease: Back.easeOut.config(1)},"-=0.2")
          ...
          .to(".texto25",0.4,{ right: '10%', ease: Back.easeOut.config(1)},"-=1.2")
          ...
          .addPause()
          //EPISODE 18
          .to(".blurEffect8",0.2,{ filter: 'blur(0px)',webkitFilter: 'blur(0px)', ease: Power0.easeNone},"epilogo")
