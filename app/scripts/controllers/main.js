  ...
  .controller('MainCtrl', function ($scope) {
      ...
      //-----TIMELINE ---------
        ...
        tl
          ...
          .to(".texto11", 0.5, {top: '9%', ease: Bounce.easeOut})
          .to(".texto12", 0.5, {top: '30%', ease: Bounce.easeOut},"-=0.2")
          .to(".texto13", 0.5, {top: '55%', ease: Bounce.easeOut},"-=0.2")
          .to(".cita11", 0.5, {bottom: '10%', ease: Bounce.easeOut},"-=0.2")
          .to(".prelGroup", 0.5, {top: '10%', ease: Bounce.easeOut},"-=0.2")
